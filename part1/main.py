...
print('test error of PCA:', test_error)
...
# print('test error of cube kernel:',test_error)
...
# y_pred=svm_model.predict(test_pca10)
# test_error=compute_test_error_svm(test_y,y_pred)
# print('test error for poly svm:', test_error)
...
y_pred=svm_model.predict(test_pca10)
test_error=compute_test_error_svm(test_y,y_pred)
print('test error for rbf svm:', test_error)